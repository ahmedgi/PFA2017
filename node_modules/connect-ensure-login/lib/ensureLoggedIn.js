 ...
 * @api public
 */
module.exports = function ensureLoggedIn(mask,options,checkIsCurrent) {
  ...
  return function(req, res, next) {  
    if (!req.isAuthenticated || !req.isAuthenticated()||(req.user.security_mask&mask)!=mask){//||(checkIsCurrent&&!(req.body.userId&&req.body.userId==req.user._id))) {
